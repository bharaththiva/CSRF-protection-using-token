<?php
	...
	{
    		if($username=="admin" && $password=="1234" && $user_CSRF==$_SESSION['CSRF'] && $user_sessionID==session_id())
    		{
        		echo "<script> alert('Sucessfully logged in!!') </script>";
        		echo "Welcome user "."<br/>"; 
        		echo "For more info visit: ".'<a href="http://bharathsec.blogspot.com/2018/06/cross-site-request-forgery-protection.html", target="_blank" >'. "https://www.bharathsec.blogspot.com"."</a>";
